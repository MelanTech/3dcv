...
from core.components.ocr.paddleocrv6.utils import get_rotate_crop_image
...
def parse_args():
    ...
    parser.add_argument("--config", default="config/ocr/paddleocrv6.yaml")
        ...
        for sample in samples:
            ...
            for rotation in ANGLES:
                ...
                row = {
                    "model": name,
                    "orientation_enabled": (
                        getattr(ocr, "_doc_orientation", None) is not None
                    ),
