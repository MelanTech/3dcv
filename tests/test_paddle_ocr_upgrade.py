...
def build_ocr(text="语文"):
    ocr = object.__new__(PaddleOcrV6)
...
class PaddleOcrUpgradeTest(unittest.TestCase):
    def test_disabled_orientation_keeps_old_flow(self):
        ...
        with patch(
            "core.components.ocr.paddleocrv6.component.resolve_engine_config",
            return_value=("onnx", {}),
        ), patch(
            "core.components.ocr.paddleocrv6.component.ONNXPaddleOcr",
            return_value=fake_engine,
        ), patch(
            "core.components.ocr.paddleocrv6.component.DocOrientationPredictor"
        ) as orientation_class:
            ocr = PaddleOcrV6(config, registry)
    ...
    def test_orientation_load_failure_falls_back(self):
        ...
        with patch(
            ...
            "core.components.ocr.paddleocrv6.component", level="WARNING"
        ) as logs:
            ocr = PaddleOcrV6(config, registry)
